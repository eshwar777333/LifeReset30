    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-white/10">
      <div className="container mx-auto px-4 lg:px-6 py-2 lg:py-3">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-2 lg:space-x-3 group transition-all duration-300 hover:scale-105">
            <div className="relative">
              <div className="w-8 h-8 lg:w-10 lg:h-10 gradient-bg rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 animate-glow-pulse">
                <Zap className="text-white text-sm lg:text-base drop-shadow-sm" />
              </div>
            ...
            <div>
              <h1 className="text-lg lg:text-xl xl:text-2xl hero-text gradient-text">
                Life Reset 30
              </h1>
          ...
          <div className="hidden md:flex items-center space-x-2 lg:space-x-3">
            {navItems.map((item) => (
              <Link
                ...
                href={item.href}
                className={cn(
                  "group relative px-3 lg:px-4 py-1.5 lg:py-2 rounded-lg transition-all duration-300 font-semibold text-xs lg:text-sm overflow-hidden",
                  location === item.href 
          ...
          <div className="group relative">
            <div className="premium-card px-3 lg:px-4 py-2 lg:py-2.5 rounded-lg border border-orange-500/30 hover-scale cursor-pointer">
              <div className="flex items-center space-x-3">
                <div className="relative">
                  <i className="fas fa-fire text-orange-500 text-base lg:text-lg animate-pulse drop-shadow-sm"></i>
                  <div className="absolute -inset-1 bg-orange-500/20 rounded-full blur-sm animate-pulse"></div>
                </div>
                <div className="text-center">
                  <div className="font-black text-lg lg:text-xl gradient-text" data-testid="streak-count">{streak}</div>
